...
Para adicionar esta visão ao projeto:

```bash
git add README.md VISION.md
git commit -m "docs: document product vision for v2 tax-finops middleware"
git push -u origin docs/product-vision-v2
```

**Draft do PR**

```text
Título: docs: documentar visão do produto e evolução para V2.0

Resumo:
- documenta o problema de capital de giro causado pelo Split Payment;
- posiciona a V1.0 como Simulador Sandbox Síncrono;
- descreve a V2.0 como middleware Tax-FinOps B2B assíncrono;
- registra limites, princípios de evolução e referências oficiais.

Impacto:
- nenhuma alteração de código ou comportamento da V1.0;
- nenhuma integração governamental declarada como implementada;
- documentação pronta para orientar o Discovery e o planejamento de Sprints da V2.0.

Checklist:
- [ ] Revisar a visão com Produto, Engenharia, Fiscal/Tributário e Segurança.
- [ ] Confirmar os requisitos atuais dos manuais oficiais de integração.
- [ ] Vincular os épicos e Sprints da V2.0 a esta visão.
```
